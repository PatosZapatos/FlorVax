...
<body>
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="../../paginaprincipal/pag1.php" class="nav-link px-2 link-secondary">Home</a></li>
            <li><a href="#" class="nav-link px-2">Features</a></li>
            <li><a href="#" class="nav-link px-2">FAQs</a></li>
            <li><a href="#" class="nav-link px-2">Pricing</a></li>
            <li><a href="../../tobi/nosotros.html" class="nav-link px-2">About</a></li>
        </ul>

        <div class="col-md-3 text-end">
            <a type="button" href="../../bootstrap/sign-in/sign-in.php" class="btn btn-outline-primary me-2">Login</a>
