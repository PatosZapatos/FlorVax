...
<body style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
    ...
    <h2 class="titulo">Pala</h2>
    <h5 class="info">-Pala antioxidable de 90 cm de largo<br>-Para excavar tierra<br>-Nueva <br>-Consultar stock</h5>
    <h1 class="precio">$12.900</h1>
    <h3 class="cuotas">Mismo precio en 3 cuotas de $4300</h3>
    <a href="../forms/tarjeta.php"><button class="boton">Comprar</button></a>
    <div class="img">
    <img src="../img/herramientas/palaaa.webp" alt="" width="600px" height="500px">
    </div>
