...
<body style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
    ...
    <h2 class="titulo">Fertilizante</h2>
    <h5 class="info">-VENENOSO NO INGERIR<br>-Para matar bichos<br>-Nueva <br>-Consultar stock</h5>
    ...
    <div class="img">
    <img src="../img/herramientas/fertilizante.webp" alt="" width="600px" height="500px">
    </div>
