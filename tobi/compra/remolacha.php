...
<body style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
    ...
    <h2 class="titulo">Semillas de Remolacha</h2>
    <h5 class="info">-60 semillas de remolacha<br>-Traidas de Brasil<br>-Si no sabe como germinar. Adjunto tutorial: <a href="https://www.youtube.com/watch?v=oRe5SdTPleI" style="text-decoration:none; color:#bf0092" target="_blank">Clic Aqui</a></h5>
    <h1 class="precio">$620</h1>
    <h3 class="cuotas">Mismo precio en 3 cuotas de $206,66</h3>
    <a href="../forms/tarjeta.php"><button class="boton">Comprar</button></a>
    <div class="img">
    <img src="../img/semillas/remolacha.png" alt="" width="600px" height="500px">
    </div>
