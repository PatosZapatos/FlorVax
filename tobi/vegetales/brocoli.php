...
?>
    ...
    <h5 class="info">-60 semillas de brocoli<br>-Traidas de Brasil<br>-Si no sabe como germinar. Adjunto tutorial: <a href="https://www.youtube.com/watch?v=PToFUFrTivM" style="text-decoration:none; color:#81d7cd" target="_blank">Clic Aqui</a></h5>
